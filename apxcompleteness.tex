...
\begin{todo}
  Show that $\textsc{Maximum \textit{k}-Satisfiability} \in \NNCO$, and hence in $\NPO$.
\end{todo}

\begin{todo}
  Show that $\textsc{Maximum 3-Satisfiability} \in \NNCO$, and hence in $\NPO$.
\end{todo}
...
\begin{lemma}\label{lem:gap3}
  There is an \NC{} (and more generally, a polynomial time) enhanced gap-introducing reduction from \textsc{Satisfiability} to \textsc{Maximum 3-Satisfiability}.
\end{lemma}
\begin{proof}
