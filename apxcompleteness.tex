...
\begin{proof}[Proof of \autoref{thm:maxcomplete}]
  ...
  \begin{todo}
    Do we need to include that $g$ must search for the appropriate $j$?
  \end{todo}
  ...
  \begin{equation}\label{eq:rupper}
    r < 1 + \frac{\epsilon}{2k(1 + 2\epsilon)},
  \end{equation}
  ...
  \begin{equation*}
    r = 1 + \frac{r_n - 1}{\alpha} < 1 + \frac{\epsilon}{2k(1 + 2\epsilon)},
  \end{equation*}
  or
  \begin{equation*}
    \alpha > \frac{2k(1 + 2\epsilon)(r_n - 1)}{\epsilon}
  \end{equation*}
  ...
  \begin{equation*}
    \alpha \geq \frac{2(r_P \log{r_P} + r_P - 1)(1 + 2\epsilon)}{\epsilon}.
  \end{equation*}
  ...
  \begin{align*}
    ...
    \alpha & = 2(r_P \log{r_P} + r_P - 1)\frac{1 + 2\epsilon}{\epsilon}
  \end{align*}
\end{proof}
